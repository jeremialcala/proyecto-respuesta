"""Sobre común de eventos (ADR-0011), idéntico en todos los servicios. Puro (stdlib).

Nota: por ahora cada servicio lleva su copia; un paquete compartido es una refactorización posterior.
"""
